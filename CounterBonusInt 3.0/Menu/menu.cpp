...
void CMenu::Setup ()
{
	...
	auto main_tab = new MenuElements::Tab;
	main_tab->SetTab (0);
	main_tab->SetTitle ("Main");
	frame->Add (main_tab);
	...
	misc_bhop->SetValue (Settings->b_bhop_enabled);
	...
	misc_autostrafe->SetValue (Settings->b_autostrafe_enabled);
