...
void ISurface::DrawSetColor (int r, int g, int b, int a)
{
	...
	return Utils::getVFunc<OriginalFn> (this, 12)(this, r, g, b, a);
}

void ISurface::DrawSetColor (Color col)
{
	typedef void (__thiscall* OriginalFn)(void*, Color);
	return Utils::getVFunc<OriginalFn> (this, 14)(this, col);
}
...
{
	typedef void (__thiscall* OriginalFn)(void*, int, int, int, int);
	return Utils::getVFunc<OriginalFn> (this, 25)(this, r, g, b, a);
}

void ISurface::DrawSetTextColor (Color col)
{
	typedef void (__thiscall* OriginalFn)(void*, Color);
	return Utils::getVFunc<OriginalFn> (this, 24)(this, col);
}
...
void ISurface::DrawPrintText (const wchar_t *text, int textLen, FontDrawType_t drawType)
{
	...
	return Utils::getVFunc<OriginalFn> (this, 28)(this, text, textLen, drawType);
}
...
int	ISurface::CreateNewTextureID (bool procedural)
{
	...
	return Utils::getVFunc<OriginalFn> (this, 43)(this, procedural);
}
...
bool ISurface::SetFontGlyphSet (HFont font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags, int nRangeMin, int nRangeMax)
{
	...
	return Utils::getVFunc<OriginalFn> (this, 72)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, nRangeMin, nRangeMax);
}
...
{
	typedef void (__thiscall* OriginalFn)(void*, int, int, int, int);
	return Utils::getVFunc<OriginalFn> (this, 103)(this, x, y, radius, segments);
}
...
void ISurface::DrawTexturedPolygon (int n, Vertex_t *pVertice, bool bClipVertices)
{
	...
	return Utils::getVFunc<OriginalFn> (this, 106)(this, n, pVertice, bClipVertices);
}